    ...
    try:
        if instructions_file.exists():
            ...
            if instructions:
                ...
                # Hard language constraint: Qwen2.5 sometimes leaks Chinese in
                # short responses. Pin to English unless the user explicitly
                # asks for another language at runtime.
                expanded_instructions = (
                    expanded_instructions.rstrip()
                    + "\n\nAlways respond in English. Do not use other scripts "
                    + "or languages unless the user explicitly asks you to."
                )
